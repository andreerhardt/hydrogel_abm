...
def plot_agents(p1l,p2l,u_displacement):
    ...
    for i in range(0,npoint):
        ...
        plt.plot((p_set1[0],p_set2[0]),(p_set1[1],p_set2[1]),color='r',linewidth=1,zorder=2,path_effects=[pe.Stroke(linewidth=1.2, foreground='kw'), pe.Normal()])
...
folders = ['output_hydro_gent_stretched_AC_05/'] 
kk      = 1
l       = []
CASE    = []
Q       = []
...
plot_barrier(Q , MESH , CASE , N1 , N2 , 1 , 2 , fMIN= 0.0  , fMAX=0.1           ,YLABEL=False,XLABEL=False)
plot_barrier(Q , MESH , CASE , N1 , N2 , 2 , 3 , fMIN= 0.5  , fMAX=0.8           ,YLABEL=False,XLABEL=False)
plot_barrier(Q , MESH , CASE , N1 , N2 , 3 , 4 , fMIN= 1.4  , fMAX=1.7           ,YLABEL=False,XLABEL=False)
plot_barrier(Q , MESH , CASE , N1 , N2 , 4 , 5 , fMIN= 1.4  , fMAX=1.7           ,YLABEL=False,XLABEL=False)
...
plt.savefig('ABM_gent_stretching.pdf',dpi=250)
plt.savefig('ABM_gent_stretching.jpeg',dpi=250)